#!/usr/bin/env python3
"""
It is an API Routes for Authentication Service
"""
...
def hello_world() -> str:
    """
    The base route for authentication service API
    """
...
def register_user() -> str:
    """
    It registers a new user if it does not exist before
    """
    try:
...
def log_in() -> str:
    """
    The logs in a user and returns session ID
    """
    try:
        email = request.form['email']
        password = request.form['password']
...
def log_out() -> str:
    """
    It finds the user with the requested session ID.
